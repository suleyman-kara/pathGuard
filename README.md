...
flowchart TD
    ...
    subgraph Panel_Pipeline ["4. Panel Modelleri & Transfer Öğrenme"]
        N --> W(Master Soft Prediction Ekleme)
        W --> X[Panel-Aware Meta-Learning]
        X --> Y(Repeated Stratified 5-Fold CV)
        Y --> Z[OOF Tahminleri Üretimi]
        Z --> AA(Klinik Eşik Optimizasyonu)
        AA --> BB[Sensitivity >= 0.90 & En İyi Class 1 F1]
